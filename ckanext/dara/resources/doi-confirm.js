// copied from the original CKAM confirm-action module
// we needed html output

"use-strict";
this.ckan.module('doi-confirm', function (jQuery, _) {
  return {
    ...
    performAction: function () {
      // take the original form and submit it (HB)
        /*
        var form = jQuery('<form/>', {
        action: this.el.attr('href'),
        method: 'POST'
      });*/
      var form = jQuery(this.el).closest('#doiregform');
    ...
    createModal: function () {
      if (!this.modal) {
        ...
        element.find('.modal-body').html(this.i18n('content')); // XXX uses html() instead of text; hb
