...
<xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns="http://da-ra.de/schema/kernel-4"
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-resourceType-v4.xsd">
        <xs:annotation>
            <xs:documentation>A predefined term to provide information about the type of resource being registered.</xs:documentation>
        </xs:annotation>
    </xs:include>
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-otherTitleType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-contributorType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-availabilityType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-relationType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-pidType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-descriptionType-v4.xsd">
        <xs:annotation>
            <xs:documentation>The type of the additional information about the registered resource.</xs:documentation>
        </xs:annotation>
    </xs:include>
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-identifierSchemaType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-timeDimensionType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-collectionModeType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-documentType-v4.xsd">
        <xs:annotation>
            <xs:documentation>The type of publication that has been made available to the public.</xs:documentation>
        </xs:annotation>
    </xs:include>
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-unitType-v4.xsd">
        <xs:annotation>
            <xs:documentation>Describes the entity being analysed or observed in the resource.</xs:documentation>
        </xs:annotation>
    </xs:include>
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-rightsCCType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-languageCodes-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-resourceLanguageCodes-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-internalClassificationSchemaType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-controlledKeywordSchemaType-v4.xsd">
        <xs:annotation>
    ...
    <xs:include schemaLocation="./ckanext/dara/dara_schema/import/dara-geoCodes-v4.xsd">
        <xs:annotation>
